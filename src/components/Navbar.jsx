    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/Pallapumaheshraju" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-500 transition-colors text-xl">
            <FaGithub />
          </a>
          <a href="https://www.linkedin.com/in/mahesh-raju-pallapu" target="_blank" rel="noopener noreferrer" className="text-white hover:text-cyan-500 transition-colors text-xl">
            <FaLinkedin />
          </a>
        </div>
      </div>
